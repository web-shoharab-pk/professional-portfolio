        ...
        <main>
            <div className="row">
                            ...
                            <div>
                                <ul>
                                 ...
                                 Git, Chrome dev tool, VS code,  Heroku, Netilfly, Github</li>
                                    <li><strong>Familiar:</strong> <br /> Typescript, Redux, Stripe (for payment),  SCSS, AOS,  React Native, Yarn</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-md-8 px-5">
                    <h1 className="font-weight-bold indigo-text">PROJECTS</h1>

                    <ProjectCard></ProjectCard>
                    <ProjectDemo></ProjectDemo>

                    <section class="card-body font-weight-bold shadow my-3 rounded">
